...
- **GitHub Starred Releases** — Paste your stars page and get one feed of the releases published across every repository you starred. Needs `GITHUB_TOKEN`; the release/pre-release/tag mix is set in Settings → Reading. See [86_feature_github_releases.md](docs/spec/86_feature_github_releases.md)
