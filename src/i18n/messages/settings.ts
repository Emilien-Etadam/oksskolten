...
export const settings = {
  ...
  'discord.sectionTitle': { ja: 'Discord チャンネル', en: 'Discord channels', zh: 'Discord 频道'},
  'discord.sectionDesc': {
    ja: 'Discord のチャンネルをフィードとして購読します（Bot トークンが必要）',
    en: 'Follow a Discord channel as a feed (needs a bot token)',
    zh: '将 Discord 频道作为订阅源接收（需要机器人令牌）',
  },
  'discord.token': { ja: 'Bot トークン', en: 'Bot token', zh: '机器人令牌'},
  'discord.tokenDesc': {
    ja: 'チャンネルの読み取りに必要な Bot トークン。Bot をサーバーに招待し、「チャンネルを見る」と「メッセージ履歴を読む」権限を付与してください',
    en: 'Bot token needed to read the channel. Invite the bot to the server and grant it View Channel and Read Message History',
    zh: '读取频道所需的机器人令牌。请将机器人邀请到服务器，并授予“查看频道”和“读取消息历史”权限',
  },
  'discord.tokenSaved': { ja: 'Discord トークンを保存しました', en: 'Discord token saved', zh: 'Discord 令牌已保存'},
  'discord.tokenDeleted': { ja: 'Discord トークンを削除しました', en: 'Discord token deleted', zh: 'Discord 令牌已删除'},
  'discord.channelUrl': { ja: 'チャンネルの URL', en: 'Channel URL', zh: '频道 URL'},
  'discord.channelUrlDesc': {
    ja: 'Discord でチャンネルのリンクをコピーして貼り付けます',
    en: 'Copy a channel link in Discord and paste it here',
    zh: '在 Discord 中复制频道链接并粘贴到此处',
  },
  'discord.channelUrlPlaceholder': {
    ja: 'https://discord.com/channels/…',
    en: 'https://discord.com/channels/…',
    zh: 'https://discord.com/channels/…',
  },
  'discord.createFeed': { ja: 'フィードを作成', en: 'Create feed', zh: '创建订阅源'},
  'discord.feedCreated': { ja: 'フィードを作成しました：${name}', en: 'Feed created: ${name}', zh: '已创建订阅源：${name}'},
